    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            while (dogCharacteristic == "")
            {
                ...
                Console.WriteLine($"\r\nEnter the desired dog characteristics to search for, separated by a comma");
                readResult = Console.ReadLine();
                if (readResult != null)
                {
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                if (ourAnimals[i, 1].Contains("dog"))
                {
                    ...
                    if (ourAnimals[i, 3].Replace("Nickname: ", "") == "lola")
                    {
                        foreach (string characteristic in dogCharacteristics)
                        {
                            if (dogDescription.Contains(characteristic.Trim()))
                            {
                                ...
                                Console.WriteLine($"\nOur dog {ourAnimals[i, 3].Replace("Nickname: ", "")} is a match for your search for " + characteristic.Trim() + "!");
